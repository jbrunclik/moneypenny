...
deploy:
	...
	cp -f systemd/ai-chatbot-checkpoint-cleanup.service ~/.config/systemd/user/
	cp -f systemd/ai-chatbot-checkpoint-cleanup.timer ~/.config/systemd/user/
	...
	systemctl --user enable ai-chatbot-checkpoint-cleanup.timer
	...
	systemctl --user start ai-chatbot-checkpoint-cleanup.timer
