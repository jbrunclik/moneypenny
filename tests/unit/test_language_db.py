...
class TestGetLanguageConversation:
    ...
    def test_different_programs_are_independent(
        ...
        test_database.get_or_create_program_conversation("language", test_user.id, "spanish")
        result = test_database.get_program_conversation("language", test_user.id, "french")
        assert result is None
...
class TestGetOrCreateLanguageConversation:
    ...
    def test_uses_default_model(self, test_database: "Database", test_user: "User") -> None:
        ...
        conv = test_database.get_or_create_program_conversation(
            "language", test_user.id, "japanese"
        )
    ...
    def test_user_isolation(self, test_database: "Database", test_user: "User") -> None:
        ...
        conv1 = test_database.get_or_create_program_conversation(
            "language", test_user.id, "spanish"
        )
        conv2 = test_database.get_or_create_program_conversation("language", user2.id, "spanish")
        assert conv1.id != conv2.id
...
class TestResetLanguageConversation:
    ...
    def test_deletes_messages(self, test_database: "Database", test_user: "User") -> None:
        ...
        result = test_database.reset_program_conversation("language", test_user.id, "spanish")
        assert result is not None
        ...
        conv_after = test_database.get_program_conversation("language", test_user.id, "spanish")
...
class TestListLanguageConversations:
    ...
    def test_excludes_other_users(self, test_database: "Database", test_user: "User") -> None:
        ...
        test_database.get_or_create_program_conversation("language", test_user.id, "spanish")
        test_database.get_or_create_program_conversation("language", user2.id, "french")
...
class TestDeleteLanguageConversation:
    ...
    def test_deletes_conversation_and_messages(
        ...
        result = test_database.delete_program_conversation("language", test_user.id, "spanish")
    ...
    def test_does_not_affect_other_programs(
        ...
        test_database.delete_program_conversation("language", test_user.id, "spanish")

        remaining = test_database.list_program_conversations("language", test_user.id)
